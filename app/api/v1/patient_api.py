...
from app.api.v1.auth import get_current_doctor, get_current_patient
...
def get_doctors(db: Session = Depends(get_db), current_user: UserModel = Depends(get_current_patient())):
